...
//    }
    ...
    public RuleVO( Integer aid,String platform, String download_url, String update_version_code, String md5,  Integer max_update_version_code, Integer min_update_version_code, Integer max_os_api, Integer min_os_api, String cpu_arch, String channel, String title, String update_tips) {
        this.aid=aid;
        this.platform = platform;
