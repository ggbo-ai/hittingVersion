...
//                       @RequestParam("device_id_list") String device_id_list,
        ...
        Response response=ruleService.addRules(new RuleVO(aid,platform,download_url,update_version_code,md5,Integer.valueOf(min_version),Integer.valueOf(max_version),
